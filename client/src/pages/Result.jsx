...
const Result = () => {
  ...
  return (
    <div className="mx-4 my-3 lg:mx-44 mt-14 min-h-[75vh]">
      <div className="bg-white rounded-1g px-8 py-6 drop-shadow-sm">
        {/*Image Container*/}

        <div className="flex felx-col sm:grid grid-cols-2 gap-8">
          {/*Left Side*/}
          <div>
            <p className="font-semibold text-gray-600 mb-2">Original</p>
            <img
              className="rounded-md border"
              src={image ? URL.createObjectURL(image) : "Nothing to take"}
              alt=""
            />
          </div>
          ...
          <div className="flex flex-col">
            ...
            <div className="rounded-md border border-gray-300 h-full relative bg-layer overflow-hidden">
              <img src={resultImage ? resultImage : "Nothing to show"} alt="" />
              {!resultImage && image && 
